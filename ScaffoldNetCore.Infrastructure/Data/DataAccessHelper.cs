...
namespace ScaffoldNetCore.Infrastructure.Data
{
    public class DataAccessHelper : IDataAccessHelper, IDisposable
    {
        ...
        /// <param name="configuration"></param>
        public void CommandWithoutParams(string sprocName)
        {
            //creating command object with connection name and proc name, and open connection for the command
            command = new SqlCommand(sprocName, new SqlConnection(GetConnection()));
        ...
        /// <param name="configuration"></param>
        public void CommandWithParams(string sprocName, SqlParameter[] parameters)
        {
